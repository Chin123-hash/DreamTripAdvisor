...
export default function PlanDetailsScreen() {
    ...
    const [agencyInfo, setAgencyInfo] = useState({ id: null, name: 'Loading...' });
        ...
        try {
            ...
            if (planData) {
                ...
                if (planData.agencyId) {
                    ...
                    setAgencyInfo({ id: null, name: "Unknown Agency" });
                }
    ...
    const renderPieChart = () => {
        ...
        // This is the Cost Per Pax
        const costPerPax = foodTotal + entTotal + hotelTotal + transTotal || 1; 
        
        // This is the Grand Total (Cost Per Pax * Pax Count)
        ...
        return (
            <View>
                {/* 1. Total Price Display (Outside Chart) */}
                <View style={styles.totalPriceContainer}>
                    <Text style={styles.totalPriceLabel}>{"Total Trip Price"}</Text>
