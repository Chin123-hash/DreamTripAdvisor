...
import {
    ActivityIndicator,
    FlatList,
    Image, // <--- Checked: StyleSheet is here
    ScrollView,
    StyleSheet,
    Text,
    TouchableOpacity,
...
// Correct Safe Area Import for all phones (Notch/Dynamic Island)
...
export default function CustomerMainPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Filter out broken data (empty titles/images) to prevent "Empty Box"
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {/* --- NEW: FLOATING ACTION BUTTON (Fixed at Bottom Right) --- */}
